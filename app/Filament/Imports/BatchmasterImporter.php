...
class BatchmasterImporter extends Importer
{
    ...
    {
        return [
            ImportColumn::make('batchsource_id')
                ->numeric()
                ->rules(['integer']),
    ...
    {
        $body = 'Your batchmaster import has completed and ' . number_format($import->successful_rows) . ' ' . str('row')->plural($import->successful_rows) . ' imported.';
