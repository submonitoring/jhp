...
use App\Filament\Exports\ReasonformovementExporter;
...
class ReasonformovementResource extends Resource
{
    ...
    public static function ReasonforMovementFormSchema(): array
    {
        return [
            ...
            Section::make('Reason for Movement')
                ->schema([
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                ColumnGroup::make('Reason for Movement', [
            ...
            ->bulkActions([
                ...
                ExportBulkAction::make()
                    ->label('Export')
                    ->exporter(ReasonformovementExporter::class)
            ]);
    }
