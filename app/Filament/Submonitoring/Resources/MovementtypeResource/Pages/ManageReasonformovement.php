...
class ManageReasonformovement extends ManageRelatedRecords
{
    protected static string $resource = MovementtypeResource::class;

    protected static string $relationship = 'reasonformovements';
    ...
    {
        return 'Reason for Movements -> Movement Type';
    }

    public function form(Form $form): Form
    {
        return ReasonformovementResource::form($form);
    }

    public function table(Table $table): Table
    {
        return $table
            ->recordTitleAttribute('reason_for_movement_desc')
            ->columns([
