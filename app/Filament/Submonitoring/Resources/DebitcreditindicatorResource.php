...
use App\Filament\Exports\DebitcreditindicatorExporter;
...
class DebitcreditindicatorResource extends Resource
{
    ...
    public static function DebitCreditIndicatorFormSchema(): array
    {
        return [
            ...
            Section::make('Debit Credit Indicator')
                ->schema([
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                ColumnGroup::make('Debit Credit Indicator', [
            ...
            ->bulkActions([
                ...
                ExportBulkAction::make()
                    ->label('Export')
                    ->exporter(DebitcreditindicatorExporter::class)
            ]);
    }
