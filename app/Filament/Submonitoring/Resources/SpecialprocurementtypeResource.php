...
use App\Filament\Exports\SpecialprocurementtypeExporter;
...
class SpecialprocurementtypeResource extends Resource
{
    ...
    public static function SpecialProcurementTypeFormSchema(): array
    {
        return [
            ...
            Section::make('Special Procurement Type')
                ->schema([
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                ColumnGroup::make('Special Procurement Type', [
            ...
            ->bulkActions([
                ...
                ExportBulkAction::make()
                    ->label('Export')
                    ->exporter(SpecialprocurementtypeExporter::class)
            ]);
    }
