...
use App\Filament\Exports\TransportationgroupExporter;
use App\Filament\Imports\TransportationgroupImporter;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                ...
                ImportAction::make()
                    ->label('Import')
                    ->importer(TransportationgroupImporter::class),
            ])
            ->actions([
                ActionGroup::make([
            ...
            ->bulkActions([
                ...
                ExportBulkAction::make()
                    ->label('Export')
                    ->exporter(TransportationgroupExporter::class)
            ]);
    }
